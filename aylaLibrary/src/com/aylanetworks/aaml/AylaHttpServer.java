 ...
 */
public abstract class AylaHttpServer {
    /**
     * Maximum time to wait on Socket.getInputStream().read() (in milliseconds)
     * This is required as the Keep-Alive HTTP connections would otherwise
     * block the socket reading thread forever (or as long the browser is open).
     */
    public static final int SOCKET_READ_TIMEOUT = 35000;		// ayla Module drops connection in 30 seconds. Add 5 seconds of guard time
    /**
    ...
    /**
     * Common mine type for JSON RFC 4627
     */
    public static final String MIME_JSON = "application/json"; 	// ayla
    /**
     ...
     */
    public AylaHttpServer(int port) {		// ayla
        this(null, port);
    }
     ...
     */
    public AylaHttpServer(String hostname, int port) {		// ayla
    ...
    public static class Response {
        ...
        public enum Status {
            ...
            PRECONDITION_FAILED(412, "Precondition Failed"),				// ayla
            RANGE_NOT_SATISFIABLE(416, "Requested Range Not Satisfiable"),
            METHOD_FAILURE(424, "Method Failure"),							// ayla
    		UPGRADE_REQUIRED(426, "Upgrade Required"),						// ayla
    		CERT_ERROR(495, "Cert Error"),									// ayla
            INTERNAL_ERROR(500, "Internal Server Error"),
            NOT_IMPLEMENTED(501, "Not Implemented"),						// ayla
    	    SERVICE_UNAVAILABLE(503, "Service Unavailable");				// ayla
    ...
    public static final class ResponseException extends Exception {
        ...
        /**
		 * Required default serialVersionUID
		 */
    ...
    protected class HTTPSession implements IHTTPSession {
                ...
                if (Method.POST.equals(method)) {
                    ...
                    if ("multipart/form-data".equalsIgnoreCase(contentType)) {
                        ...
                        if ("application/json".equalsIgnoreCase(contentType)) {
							decodeJsonParms( postLine, parms );						// ayla 
						} else {
        ...
        // ayla puts the entire json response under the key "jsonString" for later parsing
		private void decodeJsonParms( String jsonString, Map<String, String> p )
		{
			if ( jsonString == null ) {
				return;
			}
			p.put("jsonString", jsonString);	
		}
