...
*/
public class FriendRankItemDao extends AbstractDao<FriendRankItem, Void> {
    ...
    public static class Properties {
        ...
        public final static Property Userid = new Property(4, String.class, "userid", true, "USERID");
        ...
        public final static Property Notime = new Property(8, long.class, "notime", false, "NOTIME");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRIEND_RANK_ITEM\" (" + //
                ...
                "\"USERID\" TEXT PRIMARY KEY NOT NULL ," + // 4: userid
                "\"VUSERID\" TEXT," + // 5: vuserid
                "\"TYPE\" TEXT," + // 6: type
                "\"NOTIFY\" TEXT," + // 7: notify
                "\"NOTIME\" INTEGER NOT NULL ," + // 8: notime
    ...
    protected final void bindValues(DatabaseStatement stmt, FriendRankItem entity) {
        ...
        stmt.bindLong(9, entity.getNotime());
    ...
    public FriendRankItem readEntity(Cursor cursor, int offset) {
        FriendRankItem entity = new FriendRankItem( //
            ...
            cursor.getLong(offset + 8), // notime
    ...
    public void readEntity(Cursor cursor, FriendRankItem entity, int offset) {
        ...
        entity.setNotime(cursor.getLong(offset + 8));
    ...
    @Override
    protected final Void updateKeyAfterInsert(FriendRankItem entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(FriendRankItem entity) {
        return null;
    }
