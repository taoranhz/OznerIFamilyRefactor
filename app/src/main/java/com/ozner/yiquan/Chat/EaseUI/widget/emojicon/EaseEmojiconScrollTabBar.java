...
import com.ozner.yiquan.Utils.DensityUtil;
...
public class EaseEmojiconScrollTabBar extends RelativeLayout{
    ...
    public void addTab(int icon){
        ...
        int tabWidth = 60;
        LinearLayout.LayoutParams imgParams = new LinearLayout.LayoutParams(DensityUtil.dp2px(context, tabWidth), LayoutParams.MATCH_PARENT);
