...
import com.ozner.yiquan.Chat.EaseUI.Adapter.EaseMessageAdapter;
...
//    protected int chatType;
     ...
     */
    public void init(String toChatUsername, EaseCustomChatRowProvider customChatRowProvider) {
//        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        
//        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true);
        messageAdapter = new EaseMessageAdapter(context, toChatUsername, listView);
