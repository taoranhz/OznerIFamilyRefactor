...
import com.ozner.yiquan.Chat.EaseUI.domain.EaseEmojiconGroupEntity;
import com.ozner.yiquan.Chat.EaseUI.model.EaseDefaultEmojiconDatas;
import com.ozner.yiquan.Chat.EaseUI.utils.EaseSmileUtils;
import com.ozner.yiquan.Chat.EaseUI.widget.emojicon.EaseEmojiconMenu;
import com.ozner.yiquan.Chat.EaseUI.widget.emojicon.EaseEmojiconMenuBase;
...
public class EaseChatInputMenu extends LinearLayout {
    ...
    private EaseChatPrimaryMenuBase.EditTextFocusListener editFocusListener;
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (emojiconMenu == null) {
            ...
            if (emojiconGroupList == null) {
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.f_static_000, Arrays.asList(EaseDefaultEmojiconDatas.getData())));
            }
    ...
    public void setEditFocusListener(EaseChatPrimaryMenuBase.EditTextFocusListener editFocusListener) {
        this.editFocusListener = editFocusListener;
    }
