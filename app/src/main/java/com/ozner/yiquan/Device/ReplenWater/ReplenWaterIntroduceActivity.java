...
public class ReplenWaterIntroduceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_replen_water_introduce);
    ...
    private void initToolBar() {
        ...
        title.setText(R.string.replen_water);
